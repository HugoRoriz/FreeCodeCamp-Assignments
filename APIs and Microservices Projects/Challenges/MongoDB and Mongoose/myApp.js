...
var createAndSavePerson = function(done) {
  var hugoRoriz = new Person({name: "Hugo Roriz", age: 25, favoriteFoods: ["cookies", "chocolate"]});

  hugoRoriz.save(function(err, data) {
...
var arrayOfPeople = [
  {name: "Sophie", age: 34, favoriteFoods: ["Burguers"]},
  {name: "Ron", age: 43, favoriteFoods: ["Roast Chicken"]},
  {name: "Rachel", age: 33, favoriteFoods: ["Tofu"]}
];
